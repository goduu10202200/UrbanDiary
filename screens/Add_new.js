...
export default class Add_new extends React.Component {
  //地點回傳資料
  ...
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      ...
      // headerTitleStyle: styles_layout.titleTxt_black,
      headerRight: (
        <TouchableOpacity
          onPress={() => {
        ...
        >
          <Icon name={"mic"} style={styles_layout.titleIcon_gray} />
        </TouchableOpacity>
      )
    };
  };
    ...
    axios({
      ...
      .then(function (response) {
        ...
        Alert.alert("新增成功", "", [
          {
            text: "OK",
            onPress: () => self.props.navigation.navigate("Add")
          }
        ]);
